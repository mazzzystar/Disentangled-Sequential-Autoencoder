...
if __name__ == '__main__':
    ...
    trainer = Trainer(vae,device,sprites_train,sprites_test,trainloader,testloader,epochs=50,batch_size=64,learning_rate=0.0002,checkpoints='factor-disentangled-vae.model',nsamples = 2,sample_path='samples',
            recon_path='recon') 
